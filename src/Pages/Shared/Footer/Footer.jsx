        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Enjoy fast reliable portal delivery with real-time tracking and zero inside. 
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li className="flex items-start">
                ...
                <span>123 Delivery Street, Logistics City, 10001</span>
              </li>
              <li className="flex items-center">
                ...
                <span>+1 (800) PRO-FAST</span>
              </li>
              <li className="flex items-center">
                <svg className="h-5 w-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                </svg>
                <span>info@profast.com</span>
              </li>
            </ul>
          </div>
        </div>
